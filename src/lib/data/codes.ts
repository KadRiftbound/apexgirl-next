...
export const expiredCodes: PromoCode[] = [
  { code: "TOPYEAR2026",    rewards: "500 Gems + 1000 Coins",             expires: "2026-12-31", status: "expired" },
  { code: "TOPLOVERS",      rewards: "1000 Gems",                          expires: "2026-12-31", status: "expired" },
  { code: "1stAnniversary", rewards: "SSR Girl Promote Card + 500 Gems",  expires: "2026-06-30", status: "expired" },
