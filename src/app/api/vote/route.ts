...
export async function GET() {
  ...
  const sortedByTotal = [...data.votes].sort((a, b) => b.count - a.count);
  const sortedByWeek = [...data.votes].sort((a, b) => b.week_count - a.week_count);
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!data.weekly_top || data.weekly_top.week_start !== weekStart) {
