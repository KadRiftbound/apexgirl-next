...
Tokyo est la première aventure après la phase de départ sur le serveur d'origine. C'est la base de toutes les aventures Abroad. Pour bien comprendre Tokyo, il faut aussi lire le [Guide de la structure du jeu](/fr/guides/comprendre-la-structure-du-jeu-top-girl/).
...
**Le métro** — Tokyo introduit le Metro. Ce système permet d'obtenir des boosts, des récompenses et une progression supplémentaire pendant l'aventure. Voir le [Guide Metro & Subway](/fr/guides/metro-guide/).
...
Tokyo is the first adventure after the departure phase on the home server. It's the foundation of all Abroad adventures. To understand Tokyo well, you should also read the [Game Structure Guide](/en/guides/comprendre-la-structure-du-jeu-top-girl/).
...
**The Metro** — Tokyo introduces the Metro. This system allows you to get boosts, rewards and additional progression during the adventure. See the [Metro & Subway Guide](/en/guides/metro-guide/).
...
Tokyo è la prima avventura dopo la fase iniziale sul server home. È la base di tutte le avventure Abroad. Per capire bene Tokyo, dovresti anche leggere la [Guida Struttura del Gioco](/it/guides/comprendre-la-structure-du-jeu-top-girl/).
...
**Il Metro** — Tokyo introduce il Metro. Questo sistema permette di ottenere boost, ricompense e progressione aggiuntiva durante l'avventura. Vedi la [Guida Metro & Subway](/it/guides/metro-guide/).
...
Tokyo es la primera aventura después de la fase inicial en el servidor local. Es la base de todas las aventuras Abroad. Para entender bien Tokyo, también deberías leer la [Guía de Estructura del Juego](/es/guides/comprendre-la-structure-du-jeu-top-girl/).
...
**El Metro** — Tokyo introduce el Metro. Este sistema permite obtener boosts, recompensas y progresión adicional durante la aventura. Ver la [Guía Metro & Subway](/es/guides/metro-guide/).
...
Tokyo é a primeira aventura após a fase inicial no servidor local. É a base de todas as aventuras Abroad. Para entender bem Tokyo, você também deve ler o [Guia de Estrutura do Jogo](/pt/guides/comprendre-la-structure-du-jeu-top-girl/).
...
**O Metro** — Tokyo introduz o Metro. Este sistema permite obter boosts, recompensas e progressão adicional durante a aventura. Ver o [Guia Metro & Subway](/pt/guides/metro-guide/).
...
Tokyo jest pierwszą przygodą po fazie początkowej na serwerze domowym. To fundament wszystkich przygód Abroad. Aby dobrze zrozumieć Tokyo, powinieneś również przeczytać [Poradnik Struktury Gry](/pl/guides/comprendre-la-structure-du-jeu-top-girl/).
...
**Metro** — Tokyo wprowadza Metro. Ten system pozwala uzyskać boosty, nagrody i dodatkową progresję podczas przygody. Zobacz [Poradnik Metro & Subway](/pl/guides/metro-guide/).
...
Tokyo adalah petualangan pertama setelah fase awal di server rumah. Ini adalah fondasi dari semua petualangan Abroad. Untuk memahami Tokyo dengan baik, Anda juga harus membaca [Panduan Struktur Permainan](/id/guides/comprendre-la-structure-du-jeu-top-girl/).
...
**Metro** — Tokyo memperkenalkan Metro. Sistem ini memungkinkan Anda mendapatkan boost, hadiah, dan progresi tambahan selama petualangan. Lihat [Panduan Metro & Subway](/id/guides/metro-guide/).
...
Tokyo ist das erste Abenteuer nach der Startphase auf dem Heimat-Server. Es ist die Basis aller Abroad-Abenteuer. Um Tokyo gut zu verstehen, solltest du auch den [Spielstruktur-Leitfaden](/de/guides/comprendre-la-structure-du-jeu-top-girl/) lesen.
...
**Die Metro** — Tokyo führt die Metro ein. Dieses System ermöglicht es, Boosts, Belohnungen und zusätzlichen Fortschritt während des Abenteuers zu erhalten. Sieh dir den [Metro & Subway Leitfaden](/de/guides/metro-guide/) an.
...
Tokyo — первое приключение после начальной фазы на домашнем сервере. Это основа всех приключений Abroad. Чтобы хорошо понять Tokyo, вам также следует прочитать [Гайд по структуре игры](/ru/guides/comprendre-la-structure-du-jeu-top-girl/).
...
**Метро** — Tokyo представляет Метро. Эта система позволяет получать бусты, награды и дополнительный прогресс во время авантюры. См. [Гайд по Metro & Subway](/ru/guides/metro-guide/).
