...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: { fr: `${BASE_URL}/fr/guides/`, en: `${BASE_URL}/en/guides/`, it: `${BASE_URL}/it/guides/`, es: `${BASE_URL}/es/guides/`, pt: `${BASE_URL}/pt/guides/`, pl: `${BASE_URL}/pl/guides/`, id: `${BASE_URL}/id/guides/`, ru: `${BASE_URL}/ru/guides/`, "x-default": `${BASE_URL}/en/guides/` },
    },
