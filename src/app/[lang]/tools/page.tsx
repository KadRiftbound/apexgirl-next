...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: { fr: `${BASE_URL}/fr/tools/`, en: `${BASE_URL}/en/tools/`, it: `${BASE_URL}/it/tools/`, es: `${BASE_URL}/es/tools/`, pt: `${BASE_URL}/pt/tools/`, pl: `${BASE_URL}/pl/tools/`, id: `${BASE_URL}/id/tools/`, ru: `${BASE_URL}/ru/tools/`, "x-default": `${BASE_URL}/en/tools/` },
    },
