...
const meta: Record<string, { title: string; description: string; keywords: string }> = {
  fr: { title: "TopGirl Team Builder — Base artistes et synergies", description: "Team Builder TopGirl/ApexGirl/Idol Company avec stats, specialites, genres, comparaisons d'equipes et contexte de progression.", keywords: "TopGirl Team Builder, build équipe TopGirl, personnages ApexGirl, Idol Company personnages, stats personnages" },
  en: { title: "TopGirl Team Builder — Artist database and synergy tools", description: "TopGirl/ApexGirl/Idol Company Team Builder with stats, specialties, team comparisons, and progression context.", keywords: "TopGirl Team Builder, team building TopGirl, ApexGirl characters, Idol Company characters, character stats" },
