...
const meta: Record<string, { title: string; description: string; keywords: string }> = {
  ...
  it: { title: "TopGirl Artisti — Database completo di 117+ artisti", description: "Database completo di 117+ artisti di TopGirl/ApexGirl. Statistiche, abilità, tier, genere e specialità per ogni artista.", keywords: "TopGirl artisti, artisti ApexGirl, statistiche artisti TopGirl" },
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical,
      languages: { fr: `${BASE_URL}/fr/artists/`, en: `${BASE_URL}/en/artists/`, it: `${BASE_URL}/it/artists/`, es: `${BASE_URL}/es/artists/`, pt: `${BASE_URL}/pt/artists/`, pl: `${BASE_URL}/pl/artists/`, id: `${BASE_URL}/id/artists/`, ru: `${BASE_URL}/ru/artists/`, "x-default": `${BASE_URL}/en/artists/` },
    },
