...
const votes = [
  ...
  { artist_id: 68, artist_name: "Antonia", rank: "SSR", count: 0, week_count: 0 },
  { artist_id: 6, artist_name: "Anya", rank: "SSR", count: 0, week_count: 0 },
  { artist_id: 36, artist_name: "Ariadne", rank: "SSR", count: 0, week_count: 0 },
  ...
  { artist_id: 35, artist_name: "Calliope", rank: "SSR", count: 0, week_count: 0 },
  ...
  { artist_id: 34, artist_name: "Daphne", rank: "SSR", count: 0, week_count: 0 },
...
async function seedVotes() {
  try {
    ...
    console.log("Votes initialized successfully!");
    
    const data = await redis.get("votes:all");
    console.log("Verified votes:", data ? JSON.parse(data as string).length : 0, "artists");
  } catch (error) {
